	                    ...
	                    <div class="panel-body">
	                        <div class="row">
	                            ...
	                            <div class="col-sm-8 cominfo_div">
	                                 <img src="<?php echo  base_url().(!empty($Soft_settings[0]['invoice_logo'])?$Soft_settings[0]['invoice_logo']:'assets/img/icons/default.jpg')?>" class="img img-responsive inv_logo" alt="">
	                                <br>
