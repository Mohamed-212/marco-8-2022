                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control datepicker " name="from_date" id="from_date"
                                    value="<?php echo set_value('from_date', @$_GET['from_date']) ?>"
                                    placeholder='<?php echo display('start_date') ?>' autocomplete="off">
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control datepicker " name="to_date" id="to_date"
                                       value="<?php echo set_value('to_date', @$_GET['to_date']) ?>"
                                       placeholder='<?php echo display('end_date') ?>' autocomplete="off">
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
