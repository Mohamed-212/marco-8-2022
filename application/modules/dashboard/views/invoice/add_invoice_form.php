                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <?php //echo display('customer_name')        ?><!-- <i-->
                            <!--                                                class="text-danger">*</i></label>-->
                            <!--                                    <div class="col-sm-6">-->
                            ...
                            <!--                                               placeholder='-->
                            <?php //echo display('mobile')        ?><!--' id="customer_mobile_no" />-->
                            <!--                                    </div>-->
                            <!--                                </div>-->
                            <!--                                <div class="form-group row">-->
                            <!--                                    <label for="customer_name_others_address"-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="date"
                                           class="col-sm-4 col-form-label"><?php echo display('employee_name') ?> <i
                                                class="text-danger">*</i></label>
                                    <div class="col-sm-8">
                                    ...
                                    <td>
                                        ...
                                        <div id="viewassembly1" class="text-center hidden">
                                            <a style="color: blue" href="" data-toggle="modal" data-target="#viewprom"
                                               onclick="viewpro(1)">view products </a>
                                        </div>
                                    </td>
...
<!--                                    </td>-->
                                ...
                                <tr>
                                    ...
                                    <td class="text-right" colspan="2">
                                        <input type="checkbox" id="is_quotation" onclick="check_quotation();" value="0"
