...
<div class="content-wrapper">
	<section class="content-header">
		...
		<div class="header-title">
			<h1><?php echo display('sales_report_city_wise') ?></h1>
			<small><?php echo display('sales_report_city_wise') ?></small>
			<ol class="breadcrumb">
				<li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
				<li><a href="#"><?php echo display('report') ?></a></li>
				<li class="active"><?php echo display('sales_report_city_wise') ?></li>
			</ol>
		</div>
	</section>
			...
			<div class="col-sm-12">
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<?php echo form_open('dashboard/Admin_dashboard/retrieve_sales_report_city_wise', array('class' => '', 'id' => 'validate')); ?>
						<?php
						...
						<label for="country" class="col-sm-2 col-form-div"><?php echo display('country') ?> </label>
                            <div class="col-sm-4">
                                <select name="country" id="country" class="form-control">
                                        ...
                                        <option value="<?php echo $country['id']; ?>" <?=$this->input->post('country',TRUE) == $country['id'] ? 'selected' : ''?>>
						...
						<div class="form-group row">
                            ...
                            <div class="col-sm-4 custom-select">
                                <select name="cities[]" class="form-control select2" data-placeholder="<?php echo display('city') ?>" id="city"  multiple data-multiple="true">
                                    <option><?php echo display('city') ?></option>
                                    <?php foreach ($states as $state) : ?>
                                        <option value="<?=$state->id?>" <?=in_array($state->id, $this->input->post('cities',TRUE)) ? 'selected' : ''?>><?=$state->name?></option>
                                    <?php endforeach ?>
                                </select>
                            </div>
                        </div>
				...
				<div class="panel panel-bd lobidrag">
					<div class="panel-heading">
						<div class="panel-title">
							<h4><?php echo display('sales_report_city_wise') ?></h4>
						</div>
					</div>
					<div class="panel-body">
