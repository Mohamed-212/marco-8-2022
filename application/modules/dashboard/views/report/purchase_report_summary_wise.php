...
<div class="content-wrapper">
	<section class="content-header">
		...
		<div class="header-title">
			<h1><?php echo display('purchase_report_summary_wise') ?></h1>
			<small><?php echo display('purchase_report_summary_wise') ?></small>
			<ol class="breadcrumb">
				<li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
				<li><a href="#"><?php echo display('report') ?></a></li>
				<li class="active"><?php echo display('purchase_report_summary_wise') ?></li>
			</ol>
		</div>
	</section>
			...
			<div class="col-sm-12">
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<?php echo form_open('dashboard/Admin_dashboard/retrieve_purchase_report_summary_wise', array('class' => '', 'id' => 'validate')); ?>
						<?php
				...
				<div class="panel panel-bd lobidrag">
					<div class="panel-heading">
						<div class="panel-title">
							<h4><?php echo display('purchase_report_summary_wise') ?></h4>
						</div>
					</div>
					<div class="panel-body">
								...
								<table id="" class="table table-bordered table-striped table-hover">
									...
									<tbody style="text-align: center;">
										<?php if ($purchase_reports) : ?>
											<tr style="border-left: 4px solid green;">
												...
												<td>
													<?= $purchase_reports['total_paid'] ?>
												</td>
												<td>
													<?= $purchase_reports['total_quantity'] ?>
												</td>
											</tr>
										<?php endif ?>
									...
									<tfoot>
										<tr>
											...
											<td align="center">
												<b>
													<?= $purchase_reports['total_quantity'] - $return_reports['total_quantity'] ?>
												</b>
											</td>
										</tr>
									</tfoot>
