...
<div class="content-wrapper">
	<section class="content-header">
		...
		<div class="header-title">
			<h1><?php echo display('purchase_report_product_wise') ?></h1>
			<small><?php echo display('purchase_report_product_wise') ?></small>
			<ol class="breadcrumb">
				<li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
				<li><a href="#"><?php echo display('report') ?></a></li>
				<li class="active"><?php echo display('purchase_report_product_wise') ?></li>
			</ol>
		</div>
	</section>
			...
			<div class="col-sm-12">
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<?php echo form_open('dashboard/Admin_dashboard/retrieve_purchase_report_product_wise', array('class' => '', 'id' => 'validate')); ?>
						<?php
				...
				<div class="panel panel-bd lobidrag">
					<div class="panel-heading">
						<div class="panel-title">
							<h4><?php echo display('purchase_report_product_wise') ?></h4>
						</div>
					</div>
					<div class="panel-body">
						<div id="printableArea" class="ml_2">
							...
							<?php if ($reports) : ?>
								<!-- <p class="store_name"><?php echo html_escape($reports[0]['store_name']) ?></p> -->
								<div class="store_div">
									<?php if ($start_date) : ?>
									...
									<?php endif; ?>
									<p><?php echo display('total_invoice') ?> : <strong><?php echo count($reports) ?></strong></p>
								</div>
							<?php endif; ?>
									...
									<tbody>
										...
										if (@$reports) {
											...
											foreach ($reports as $report) :
												$next = 0;
												$total_purchase += $report['grand_total_amount'];
										?>

												<tr>
													<td align="center"><?php echo $sl++; ?></td>
													<td align="center">
														<a href="<?php echo base_url() . 'dashboard/Cpurchase/purchase_inserted_data/' . $report['purchase_id']; ?>">
															<?php echo html_escape($report['invoice']) ?> <i class="fa fa-tasks pull-right" aria-hidden="true"></i>
														</a>
													</td>
												...
												<?php foreach ($report['all_details'] as $invoice) : $next++; ?>
													<tr>
														...
														<td class='hide-me'><?= $invoice['vat_rate'] ?></td>
							...
							<div class="table-responsive mt_10">
								<table id="" class="table table-bordered table-striped table-hover">
									...
									<tbody>
										...
										?>
												...
												<tr>
													<td align="center"><?php echo $sl++; ?></td>
													<td align="center">
														<a href="<?php echo base_url() . 'dashboard/Cpurchase_return/purchase_return_details_data/' . $report['purchase_return_id']; ?>">
															<?php echo html_escape($report['purchase_return_id']) ?> <i class="fa fa-tasks pull-right" aria-hidden="true"></i>
														</a>
													</td>
													<td align="center"><?php echo html_escape(date('d-m-Y', strtotime($report['date_time']))) ?></td>
												</tr>
												...
												<?php endif ?>
										<?php
												$total_return_purchase += $total_return_amount;
											endforeach;
										}
										?>
									</tbody>
									<tfoot>
										<tr>
											<td colspan="9" align="right"><b><?php echo display('grand_total') ?>:</b></td>
											<td align="center"><b><?php echo html_escape($total_return_purchase); ?></td>
										</tr>
									</tfoot>
								</table>
							</div>
							...
							<div class="table-responsive mt_10">
								<table id="" class="table table-bordered table-striped table-hover">
									...
									<tbody>
										<td align="center"><b><?php echo html_escape($total_purchase - $total_return_purchase); ?></td>
									</tbody>
								</table>
							</div>
						</div>
