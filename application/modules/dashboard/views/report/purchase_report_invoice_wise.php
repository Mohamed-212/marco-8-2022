...
<div class="content-wrapper">
	<section class="content-header">
		...
		<div class="header-title">
			<h1><?php echo display('purchase_report_invoice_wise') ?></h1>
			<small><?php echo display('purchase_report_invoice_wise') ?></small>
			<ol class="breadcrumb">
				<li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
				<li><a href="#"><?php echo display('report') ?></a></li>
				<li class="active"><?php echo display('purchase_report_invoice_wise') ?></li>
			</ol>
		</div>
	</section>
			...
			<div class="col-sm-12">
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<?php echo form_open('dashboard/Admin_dashboard/retrieve_purchase_report_invoice_wise', array('class' => '', 'id' => 'validate')); ?>
						<?php
				...
				<div class="panel panel-bd lobidrag">
					<div class="panel-heading">
						<div class="panel-title">
							<h4><?php echo display('purchase_report_invoice_wise') ?></h4>
						</div>
					</div>
					<div class="panel-body">
						<div id="printableArea" class="ml_2">
									...
									<tbody>
										...
										if ($reports) {
											...
											foreach ($reports as $invoice) :
												$next = 0;
												$total_purchase += $invoice['grand_total_amount'];
										?>
							...
							<div class="table-responsive mt_10">
								<table id="" class="table table-bordered table-striped table-hover">
									...
									<tbody>
										<td align="center"><b><?php echo html_escape($total_purchase - $total_return_sales); ?></td>
									</tbody>
								</table>
							</div>
						</div>
