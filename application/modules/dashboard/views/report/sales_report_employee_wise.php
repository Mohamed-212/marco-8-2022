...
<div class="content-wrapper">
	<section class="content-header">
		...
		<div class="header-title">
			<h1><?php echo display('sales_report_employee_wise') ?></h1>
			<small><?php echo display('sales_report_employee_wise') ?></small>
			<ol class="breadcrumb">
				<li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
				<li><a href="#"><?php echo display('report') ?></a></li>
				<li class="active"><?php echo display('sales_report_employee_wise') ?></li>
			</ol>
		</div>
	</section>
			...
			<div class="col-sm-12">
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<?php echo form_open('dashboard/Admin_dashboard/retrieve_sales_report_employee_wise', array('class' => '', 'id' => 'validate')); ?>
						<?php
						date_default_timezone_set(DEF_TIMEZONE);
						$today = date('d-m-Y'); ?>

						<div class="form-group row">
							<label for="store_id" class="col-sm-2 col-form-label"><?php echo display('employee') ?>:</label>
							<div class="col-sm-4">
								<select class="form-control" name="employee_id" id="employee_id" required="">
									<option value=""></option>
									<?php foreach ($employees as $emp) : $emp = (object)$emp; ?>
										<option value="<?= $emp->id ?>" <?= $emp->id == $employee_id ? 'selected' : '' ?>><?= $emp->first_name ?> <?= $emp->last_name ?></option>
									<?php endforeach ?>
								</select>
							</div>
						</div>
				...
				<div class="panel panel-bd lobidrag">
					<div class="panel-heading">
						<div class="panel-title">
							<h4><?php echo display('sales_report_employee_wise') ?></h4>
						</div>
					</div>
					<div class="panel-body">
