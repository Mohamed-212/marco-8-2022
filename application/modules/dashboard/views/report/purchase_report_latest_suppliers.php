...
<div class="content-wrapper">
	<section class="content-header">
		...
		<div class="header-title">
			<h1><?php echo display('purchase_report_latest_suppliers') ?></h1>
			<small><?php echo display('purchase_report_latest_suppliers') ?></small>
			<ol class="breadcrumb">
				<li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
				<li><a href="#"><?php echo display('report') ?></a></li>
				<li class="active"><?php echo display('purchase_report_latest_suppliers') ?></li>
			</ol>
		</div>
	</section>
			...
			<div class="col-sm-12">
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<?php echo form_open('dashboard/Admin_dashboard/retrieve_purchase_report_latest_suppliers', array('class' => '', 'id' => 'validate')); ?>
						<?php
				...
				<div class="panel panel-bd lobidrag">
					<div class="panel-heading">
						<div class="panel-title">
							<h4><?php echo display('purchase_report_latest_suppliers') ?></h4>
						</div>
					</div>
					<div class="panel-body">
									...
									<tbody>
										...
										if ($sales_reports) {
											...
											foreach ($sales_reports as $invoice) :
												$sl++;
												$next = 0;
												$total_sale += $invoice['balance'][0][0]['total_credit'] - $invoice['balance'][1][0]['total_debit'];
										?>
												...
												<tr>
													...
													<td>
														<a href="<?= base_url() . '/dashboard/Csupplier/supplier_ledger/' . $invoice['supplier_id'] ?>"><?= $invoice['supplier_name'] ?></a>
													</td>
													<td>
														<?php
														$q = $this->db->select('created_at')->from('product_purchase')->where('supplier_id', $invoice['supplier_id'])->order_by('created_at', 'asc')->limit(1)->get()->result_array();
													...
													<td>
														<?php
														echo $invoice['balance'][0][0]['total_credit'] - $invoice['balance'][1][0]['total_debit'];
														?>
													</td>
												</tr>
										<?php
