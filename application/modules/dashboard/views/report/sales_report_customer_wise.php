...
<div class="content-wrapper">
	<section class="content-header">
		...
		<div class="header-title">
			<h1><?php echo display('sales_report_customer_wise') ?></h1>
			<small><?php echo display('sales_report_customer_wise') ?></small>
			<ol class="breadcrumb">
				<li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
				<li><a href="#"><?php echo display('report') ?></a></li>
				<li class="active"><?php echo display('sales_report_customer_wise') ?></li>
			</ol>
		</div>
	</section>
			...
			<div class="col-sm-12">
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<?php echo form_open('dashboard/Admin_dashboard/retrieve_sales_report_customer_wise', array('class' => '', 'id' => 'validate')); ?>
						<?php
				...
				<div class="panel panel-bd lobidrag">
					<div class="panel-heading">
						<div class="panel-title">
							<h4><?php echo display('sales_report_customer_wise') ?></h4>
						</div>
					</div>
					<div class="panel-body">
						<div id="printableArea" class="ml_2">
							...
							<?php if (@$sales_reports) : ?>
								...
								<div class="store_div">
									...
									<?php endif; ?>
									<p><?php echo display('total_invoice') ?> : <strong><?php echo count($sales_reports) - 1 ?></strong></p>
								</div>
							<?php endif; ?>
									...
									<tbody>
										...
										if (@$sales_reports) {
											...
											foreach ($sales_reports as $invoice) :
												...
												$total_sale_customer += $invoice['total_amount'];
										?>
												<tr>
													<td>
												...
												<?php if ($sales_reports['customers'][$invoice['customer_id']] == $next) : $next = 0; ?>
													<tr>
														<td>--</td><td>--</td><td>--</td><td>--</td><td>--</td><td>--</td>
														<td align="right"><b><?php echo display('grand_total') ?>:</b></td>
														<td align="center"><b><?php echo html_escape($total_sale_customer); ?></td>
														<td>--</td>
													</tr>
												<?php $total_sale_customer = 0;
												endif ?>
										<?php
												$next++;
											endforeach;
							...
							<div class="table-responsive mt_10">
								<table id="" class="table table-bordered table-striped table-hover dataTablePagination dataTablePaginationNoSorting">
									<thead>
										<tr>
											<th class="text-center"><?php echo display('invoice') ?></th>
											<th class="text-center"><?php echo display('date') ?></th>
									...
									<tbody>
										...
										if (@$return_reports) {
											...
											foreach ($return_reports as $invoice) :
												...
												$total_return_sales_customer += $invoice['total_total_return'];
										?>
												...
												<?php if ($return_reports['customers'][$invoice['customer_id']] == $next) : $next = 0; ?>
													<tr>
														<td>--</td><td>--</td><td>--</td><td>--</td><td>--</td><td>--</td>
														<td align="right"><b><?php echo display('grand_total') ?>:</b></td>
														<td align="center"><b><?php echo html_escape($total_return_sales_customer); ?></td>
														<td>--</td>
													</tr>
												<?php $total_sale_customer = 0;
												endif ?>
