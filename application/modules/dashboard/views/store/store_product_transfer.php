        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="column">
                    ...
                    <a href="<?php echo base_url('dashboard/Cstore/manage_store_product') ?>"
                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="store_name"
                                        class="col-sm-4 col-form-label"><?php echo display('store_name') ?>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control" id="transfer" name="t_store_id"
                                            required=""></select>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="submit" id="add-store" class="btn btn-success btn-large" name="add-store"
