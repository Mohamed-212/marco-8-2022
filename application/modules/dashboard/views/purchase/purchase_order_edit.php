            ...
            <div class="col-sm-12">
                <div class="column">
                    <?php if ($this->permission->check_label('purchase_order')->read()->access()) { ?>
                        <a href="<?php echo base_url('dashboard/Cpurchase/purchase_order') ?>" class="btn btn-success m-b-5 m-r-2"><i class="ti-align-justify"> </i>
                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" tabindex="3" class="form-control datepicker2" name="purchase_date" value="<?php echo html_escape(date('d-m-Y', strtotime($purchase_date))); ?>" id="date" required />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="purchase_order" class="col-sm-4 col-form-label"><?php echo display('purchase_order') ?>
                                        <i class="text-danger">*</i>
                                    </label>
                                    <div class="col-sm-8">
                                        <input type="text" tabindex="3" class="form-control" name="purchase_order" value="<?php echo html_escape($pur_order_no); ?>" placeholder="<?php echo display('purchase_order') ?>" id="purchase_order" readonly />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea class="form-control" tabindex="1" id="adress" name="purchase_details" placeholder=" <?php echo display('details') ?>" rows="1"><?php echo html_escape($purchase_details); ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-sm-8">
                                        <select name="store_id" id="store_id" class="form-control width_100p" required="">
                                            ...
                                            <?php foreach ($store_list as $store) : ?>
                                                <option value="<?php echo html_escape($store['store_id']) ?>" <?php echo ((@$store_id == $store['store_id']) ? 'selected' : '') ?>>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="date" class="col-sm-4 col-form-label"><?php echo display('supply_date') ?>
                                        <i class="text-danger">*</i>
                                    </label>
                                    <div class="col-sm-8">
                                ...
                                <tbody id="addPurchaseItem">
                                    ...
                                    if ($purchase_info) {
                                        ...
                                        foreach ($purchase_info as $purchase) {
                                            ...
                                            $this->db->from('purchase_stock_tbl a');
                                    ...
                                    ?>
                                            <tr>
                                                <td>
                                                    <input type="text" name="product_name" required class="form-control product_name productSelection" onkeyup="product_pur_or_list(<?php echo $sl ?>);" placeholder="<?php echo display('product_name') ?>" id="product_name_<?php echo $sl ?>" tabindex="5" value="<?php echo html_escape($purchase['product_name']) . '-(' . html_escape($purchase['product_model']) ?>)" readonly="">
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <?php if (in_array('color', $vtypes_arr)) { ?>
                                                        <div>
                                                            <select name="color_variant[<?php echo $sl ?>]" id="color_variant_<?php echo $sl ?>" class="form-control color_variant width_100p" disabled="">
                                                                <option value=""></option>
                                                                <?php
                                                                if (!empty($pvariants)) {
                                                                ...
                                                                ?>
                                                                            <option value="<?php echo html_escape($vitem['variant_id']) ?>" <?php
                                                        ...
                                                        <?php } else { ?>
                                                            <input type="hidden" name="color_variant[<?php echo $sl ?>]" id="variant_color_id<?php echo $sl ?>">
                                                        <?php } ?>
                                                        </div>
                                                        <div class="variant_id_div">
                                                            <select name="variant_id[<?php echo $sl ?>]" id="variant_id_<?php echo $sl ?>" class="form-control variant_id width_100p" disabled="">
                                                                <option value=""></option>
                                                                <?php
                                                                if (!empty($pvariants)) {
                                                                    foreach ($pvariants as $vitem) {
...
<!--                                                    <input type="text" id="expiry_date_--><?php //echo $sl ?><!--" name="expiry_date[--><?php //echo $sl ?><!--]" value="--><?php //echo (empty($purchase['expiry_date']) || strlen($purchase['expiry_date']) < 2) ? '' : html_escape(date('d-m-Y', strtotime($purchase['expiry_date']))) ?><!--" class="form-control datepicker2" placeholder="--><?php //echo display('enter_expire_date') ?><!--" />-->
                                                ...
                                                <td class="text-right">
                                                    <input type="number" id="avl_qntt_<?php echo $sl ?>" class="form-control text-right" placeholder="0" readonly value="<?php echo html_escape($total_purchase->total_purchase - $total_sale->total_sale); ?>" />
                                                </td>

                                                <td class="text-right">
                                                    <input type="number" name="product_quantity[<?php echo $sl ?>]" onkeyup="calculate_add_purchase(<?php echo $sl ?>);" onchange="calculate_add_purchase(<?php echo $sl ?>);" id="total_qntt_<?php echo $sl ?>" class="p_quantity form-control text-right" placeholder="0" value="<?php echo html_escape($purchase['quantity']) ?>" min="0" required />
                                                </td>
                                                <td>
                                                    <input type="number" name="product_rate[<?php echo $sl ?>]" value="<?php echo html_escape($purchase['rate']) ?>" id="price_item_<?php echo $sl ?>" class="price_item<?php echo $sl ?> text-right form-control" onkeyup="calculate_add_purchase(<?php echo $sl ?>);" onchange="calculate_add_purchase(<?php echo $sl ?>);" placeholder="0.00" min="0" required />
                                                </td>
                                                <!-- Discount -->
                                                <td>
                                                    <input type="number" name="discount[<?php echo $sl ?>]" onkeyup="calculate_add_purchase(<?php echo $sl; ?>);" onchange="calculate_add_purchase(<?php echo $sl; ?>);" id="discount_<?php echo $sl; ?>" class="form-control text-right" value="<?php echo html_escape($purchase['discount']) ?>" placeholder="0.00" min="0" />
                                                </td>
                                                <td>
                                                    <input type="number" name="vat_rate[<?php echo $sl ?>]" value="<?php echo html_escape($purchase['vat_rate']) ?>" onkeyup="calculate_add_purchase(<?php echo $sl ?>);" onchange="calculate_add_purchase(<?php echo $sl ?>);" id="item_vat_rate_<?php echo $sl ?>" class="form-control text-right" placeholder="0.00" min="0" />
                                                </td>

                                                <td>
                                                    <input type="number" name="vat[<?php echo $sl ?>]" value="<?php echo html_escape($purchase['vat']) ?>" id="item_vat_<?php echo $sl ?>" class="form-control text-right item_vat" placeholder="0.00" min="0" readonly />
                                                </td>
                                                <td class="text-right">
                                                    <input class="total_price text-right form-control" value="<?php echo html_escape($purchase['total_amount']) ?>" type="text" name="total_price[<?php echo $sl ?>]" id="total_price_<?php echo $sl ?>" readonly="readonly" />
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <input type="text" id="subTotal" value="<?php echo html_escape($purchase_info[0]['sub_total_price']) ?>" class="text-right form-control" name="sub_total_price" placeholder="0.00" readonly="readonly" />
                                        </td>
                                        <th>
                                            <?php echo display('total_number_of_items') ?>
                                        </th>
                                        <td>
                                            <input type="text" id="total_items" onchange="calculate_add_purchase_cost(1);" value="<?php echo html_escape($purchase_info[0]['total_items']) ?>" class="text-right form-control" name="total_number_of_items" placeholder="0" readonly="readonly" />
                                        </td>
                                        <td class="text-right">
                                            <b><?php echo display('total_vat') ?>:</b>
                                        </td>
                                        <td>
                                            <input type="text" id="total_vat" value="<?php echo html_escape($purchase_info[0]['total_purchase_vat']) ?>" class="text-right form-control" name="total_purchase_vat" placeholder="0.00" readonly="readonly" />
                                        </td>
                                        <td class="text-right">
                                            <b><?php echo display('total_dis') ?>:</b>
                                        </td>
                                        <td>
                                            <input type="number" id="total_dis" value="<?php echo html_escape($purchase_info[0]['total_purchase_dis']) ?>" class="text-right form-control" name="total_purchase_dis" onkeyup="calculate_total();" onchange="calculate_total();" placeholder="0.00" />
                                        </td>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <input type="submit" id="edit-purchase" class="btn btn-primary btn-large" name="edit-purchase" value="<?php echo display('submit') ?>" />
                            </div>
                        </div>
                        <?php echo form_close() ?>
                    </div>
