...
//                                                                        echo "<th class='hide-me'>" . display('unit_price_before_VAT') . "</th>";
                                                            ...
                                                            <tbody>
                                                                ...
                                                                ?>
                                                                        <tr class="<?=$invoice['category_id'] == $acc_cate_id->category_id && $order_detail_all['product_type'] == 2 ? 'print-none' : 'shown'?>">
...
<!--                                                                            </td>-->
                                                                                ...
                                                                                <table class="table colored tabled" style="width: 100%">
                                                                                    <tr>
                                                                                        ...
                                                                                        <?php
                                                                                            ...
                                                                                            $this->db->where('a.order_id', $invoice_id);
                                                                                    ...
                                                                                    <?php if ($t_discount_val_real > 0) : ?>
                                                                                        ...
                                                                                        if ($t_discount_val_real > 0){
                                                                                            ...
                                                                                            echo (($position == 0) ? $currency . " " . $t_discount_val_real : $t_discount_val_real . " " . $currency);
    ...
    color: inherit !important;">
                                                                                                <div style="display: flex;justify-items: center;align-items: center;height: 6rem; /* padding: 100%; */justify-content: center;color: inherit !important;">
                                                                                                <?php
                                                                                                $totalQuantity = 0;
