                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right" colspan="2">
                                            <input type="text" id="invoice_discount" class="form-control text-right" name="invoice_discount" <?php if ($order_discount > 0) : ?> data-value="<?php if ($order_discount) {
                                                                                                                                                                                                    echo ($order_discount);
                                                                                                                                                                                                } else {
                                                                                                                                                                                                    echo 0;
                                                                                                                                                                                                } ?>" <?php endif ?> value="<?php if ($order_discount) {
                                                                                                                                                                                                                                echo ($order_discount);
                                                                                                                                                                                                                            } else {
                                                                                                                                                                                                                                echo 0;
        ...
        $(document).on('change', '#product_type', function() {
            ...
            $('[name="product_rate[]"]').each(function(inx, el) {
                ...
                if (val == '2') {
                    ...
                    if (catId == accessories_category_id) {
                        console.log(price, val, $('#price_item_saved_' + counter).val());
