                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="invoice_no" value="<?php echo set_value('invoice_no', @$_GET['invoice_no']) ?>" placeholder='<?php echo display(isset($is_order) ? 'order_no' : 'invoice_no') ?>'>
                            </div>
                        </div>
                        <div class="col-sm-3">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo isset($is_order) ? base_url() . 'dashboard/Corder/order_inserted_data/' . html_escape($invoice['order_id']) :  base_url() . 'dashboard/Cinvoice/invoice_inserted_data/' . html_escape($invoice['order_id']); ?>">

                                                        <?php echo html_escape($invoice['order']) ?>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <?php else : ?>
                                                        <?php echo form_open('dashboard/Cinvoice/update_status/' . $invoice['order_id'], array('id' => 'validate')); ?>
                                                    ...
                                                    <td>
                                                        <center>
                                                            ...
                                                            <?php if ($invoice['order_status'] == 1) { ?>
                                                                <?php if ($this->permission->check_label('new_sale')->create()->access()) { ?>
                                                                    <a href="<?php echo base_url() . 'dashboard/Corder/create_invoice_form/' . $invoice['order_id']; ?>" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="left" title="Invoice-2"><i class="fa fa-arrow-right" aria-hidden="true"></i></a>
                                                                <?php }
                                                            } else { ?>
                                                ...
                                                <?php else : ?>
                                                    <td>
                                                        <center>
                                                            <?php if ($this->permission->check_label('new_sale')->access()) { ?>
                                                                <a href="<?php echo base_url() . 'dashboard/Cinvoice/invoice_inserted_data/' . $invoice['order_id']; ?>" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="left" title="<?php echo display('invoice') ?>"><i class="fa fa-window-restore" aria-hidden="true"></i></a>
                                                            <?php }
                                                            if ($this->permission->check_label('pos_sale')->read()->access()) { ?>
                                                                <!--<a href="<?php //echo base_url() . 'dashboard/Cinvoice/pos_invoice_inserted_data/' . $invoice['order_id']; 
                                                                                ?>"
                                                    ...
                                                    title="<?php //echo display('pos_invoice') 
                                                        ...
                                                        aria-hidden="true"></i></a>-->
                                                            ...
                                                            <!--<a href="<?php //echo base_url() . 'dashboard/Cinvoice/pad_invoice/' . $invoice['order_id']; 
                                                                            ?>"
                                                    ...
                                                    title="<?php //echo display('pad_invoice') 
                                                        ...
                                                        aria-hidden="true"></i></a>-->
                                                            ...
                                                            <?php if ($this->permission->check_label('manage_sale')->update()->access()) { ?>
                                                                <!--<a href="<?php //echo base_url() . 'dashboard/Cinvoice/invoice_update_form/' . $invoice['order_id']; 
                                                                                ?>"
                                                    ...
                                                    data-placement="left" title="<?php //echo display('update') 
                                                        ...
                                                        class="fa fa-pencil" aria-hidden="true"></i></a>-->
                                                            ...
                                                            if ($this->permission->check_label('manage_sale')->delete()->access()) { ?>
                                                                <!--<a href="<?php //echo base_url('dashboard/Cinvoice/invoice_delete/' . $invoice['order_id']) 
                                                                                ?>"
