...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1><?php echo display('customer_balance_report') ?></h1>
            <small><?php echo display('customer_balance_report') ?></small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#"><?php echo display('customer') ?></a></li>
                <li class="active"><?php echo display('customer_balance_report') ?></li>
            </ol>
        </div>
    </section>
            ...
            <div class="col-sm-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <?php echo form_open('dashboard/Ccustomer/customer_balance_report', array('class' => 'form-inline')); ?>
                            ...
                            <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center">Customer TAX Number</th>
                                        <th class="text-center">Customer's Commercial Registration Number</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    if (!empty($customers_transection_report)) {
                                        foreach ($customers_transection_report as $key => $transection_report) {
                                    ?>
                                    <tr>
                                        <td><?php echo $key + 1; ?></td>
                                        <td><?php echo html_escape($transection_report['customer_name']); ?></td>
                                        ...
                                        <td><?php echo html_escape($transection_report['customer_mobile']); ?></td>
