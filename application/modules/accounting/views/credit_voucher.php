            ...
            <div class="col-sm-12 col-md-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body hideme">
                        <?php echo $print_only ? '<form>' : form_open_multipart('accounting/accounting/credit_voucher', 'id="validate"') ?>
                        <table>
                            <?php if ($print_only) : ?>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="2" style="padding-left: 30px;">
                                                <div class="">
                                                    <?php echo display('debit_account_head') ?>:&nbsp;&nbsp; <?php echo html_escape($data['cmbDebit']); ?>
                                                </div>
                                            </td>
                        ...
                        <div class="form-group row" style="margin-top: 150px;">
                            <div class="col-sm-12 text-right footer-btns">
                                <?php if ($print_only) : ?>
                                    ...
                                    <a href="<?= base_url() . '/accounting/accounting/credit_voucher' ?>" class="btn btn-success">
                                        <?= display('add_another') ?>
                                    </a>
                                <?php else : ?>
...
<?php $this->load->view('accounting/components/credit_voucher_js') ?>
<script>
